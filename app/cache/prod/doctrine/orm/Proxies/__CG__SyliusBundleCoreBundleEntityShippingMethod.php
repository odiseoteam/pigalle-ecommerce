 ...
 */
class ShippingMethod extends \Sylius\Bundle\CoreBundle\Entity\ShippingMethod implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'name', 'configuration', 'categoryRequirement', 'calculator', 'enabled', 'createdAt', 'updatedAt', 'category', 'id', 'zone');
    }
