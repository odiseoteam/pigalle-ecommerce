 ...
 */
class DefaultTaxon extends \Sylius\Bundle\TaxonomiesBundle\Entity\DefaultTaxon implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'name', 'slug', 'permalink', 'description', 'left', 'right', 'level', 'taxonomy', 'id', 'children', 'parent');
    }
